...
var project_list = [
  {
    ...
    githubUrl: "https://github.com/gregbrunk/fourteeners",
    websiteUrl: "https://fourteeners-app.herokuapp.com/"
  },
  {
    title: "Politicator",  
    categories: ["Design", "Development"],
    ...
    githubUrl: "https://github.com/gregbrunk/politicator",
    websiteUrl: "http://politicator.herokuapp.com/"
  },
  {
    ...
    githubUrl: "none",
    websiteUrl: "https://www.dropbox.com/sh/on074edgsa3t3h6/AAA1cavZUHwGABhb01LKo0y_a?dl=0"
  },
];
...
db.Project.remove({}, function(err, projects){
  if(err) {
    ...
    db.Card.create(cards_list, function(err, projects){
